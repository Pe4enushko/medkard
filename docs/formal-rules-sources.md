...
| приказ МЗ РФ от 13.10.2017 № 804н «Об утверждении номенклатуры медицинских услуг» (ред. 24.09.2020) | действует | PDF Гарант: общие положения, типы A01–A27 и записи A11.02.002/A16.01.004; префильтры `service_code_prefixes` для исследований/вмешательств и детектор типа визита |
